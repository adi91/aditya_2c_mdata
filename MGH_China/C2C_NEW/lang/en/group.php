...
$string['creategroup'] = 'Create class';
$string['creategrouping'] = 'Create batch';
$string['creategroupinselectedgrouping'] = 'Create class in grouping';
...
$string['defaultgroupname'] = 'Class';
$string['deleteallgroupings'] = 'Delete all groupings';
$string['deleteallgroups'] = 'Delete all class';
$string['deletegroupconfirm'] = 'Are you sure you want to delete class \'{$a}\'?';
...
$string['deleteselectedgroup'] = 'Delete selected class';
$string['editgroupingsettings'] = 'Edit grouping settings';
$string['editgroupsettings'] = 'Edit class settings';
$string['enrolmentkey'] = 'Enrollment key';
$string['enrolmentkey_help'] = 'An enrolment key enables access to the course to be restricted to only those who know the key. If a class enrolment key is specified, then not only will entering that key let the user into the course, but it will also automatically make them a member of this class.';
$string['erroraddremoveuser'] = 'Error adding/removing user {$a} to class';
$string['erroreditgroup'] = 'Error creating/updating class {$a}';
$string['erroreditgrouping'] = 'Error creating/updating grouping {$a}';
$string['errorinvalidgroup'] = 'Error, invalid class {$a}';
$string['errorselectone'] = 'Please select a single class before choosing this option';
$string['errorselectsome'] = 'Please select one or more class before choosing this option';
...
$string['filtergroups'] = 'Filter class by:';
$string['group'] = 'class';
$string['groupaddedsuccesfully'] = 'class {$a} added successfully';
$string['groupby'] = 'Specify';
$string['groupdescription'] = 'Class description';
...
$string['groupingdescription'] = 'Batch description';
$string['groupingname'] = 'Batch name';
...
$string['groupmodeforce'] = 'Force class mode';
$string['groupmodeforce_help'] = 'If class mode is forced, then the course class mode is applied to every activity in the course. Class mode settings in each activity are then ignored.';
...
$string['groupsinselectedgrouping'] = 'Classes in:';
...
$string['grouptemplate'] = 'Class @';
$string['hidepicture'] = 'Hide picture';
$string['importgroups'] = 'Import Classes';
$string['importgroups_help'] = 'Classes may be imported via text file. The format of the file should be as follows:
...
$string['members'] = 'Members per class';
$string['membersofselectedgroup'] = 'Members of:';
$string['namingscheme'] = 'Naming scheme';
$string['namingscheme_help'] = 'The at symbol (@) may be used to create groups with names containing letters. For example Class @ will generate groups named Group A, Group B, Group C, ...
...
$string['showmembersforgroup'] = 'Show members for class';
