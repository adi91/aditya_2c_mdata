...
$string['categories'] = 'Center list';
$string['category'] = 'Center';
if($CFG->theme == 'mghc2c'){
$string['categories'] = 'Institute list';
$string['category'] = 'Institute';
}
$string['category_help'] = 'This setting determines the center in which the course will appear in the list of courses.';
...
$string['coursecategorydeleted'] = 'Deleted center {$a}';
if($CFG->theme == 'mghc2c'){
$string['coursecategorydeleted'] = 'Deleted institute {$a}';
}
...
$string['group'] = 'Class';
$string['groupadd'] = 'Add new class';
$string['groupaddusers'] = 'Add selected to class';
$string['groupextendenrol'] = 'Extend enrollment (common)';
$string['groupfor'] = 'for class';
$string['groupinfo'] = 'Info about selected class';
$string['groupinfoedit'] = 'Edit class settings';
$string['groupinfomembers'] = 'Info about selected members';
$string['groupinfopeople'] = 'Info about selected people';
$string['groupmembers'] = 'Class members';
$string['groupmemberssee'] = 'See class members';
$string['groupmembersselected'] = 'Members of selected class';
$string['groupmode'] = 'Class mode';
$string['groupmodeforce'] = 'Force group mode';
$string['groupmy'] = 'My Class';
$string['groupnonmembers'] = 'People not in a class';
$string['groupnotamember'] = 'Sorry, you are not a member of that class';
$string['grouprandomassign'] = 'Randomly assign all to classes';
...
$string['norolemessage'] = 'No role has been assigned to you please contact center admin.';
$string['norolemessagec2c'] = 'No role has been assigned to you please contact Institute Coordinator.';
...
$string['sectionname'] = 'Lesson name';
$string['sections'] = 'Lessons';
$string['sectionusedefaultname'] = 'Use default lesson name';
...
$string['section_startdate'] = 'Lesson start date';
$string['class_startdate'] = 'Class start date';
...
/* Changes for student page */
$string['studenthomepagemsg']= 'Your tasks and lessons for today';
$string['studentactivity']= 'Activity';
$string['nocourse']= 'No courses currently scheduled for you.';

/* changes for student course page */
$string['teacherare']='teachers are';
$string['nationality']='Nationality';
$string['DOB']='DOB';
$string['TCL']='TCL';
$string['studcompletion']='Completion';
$string['taskcomptleted']='Tasks Completed';
$string['nocouserlessonfortheday']= 'No lesson scheduled today';
$string['forcourse']='for course:';

/* strings added for center creation form */
$string['centers'] = 'Centers';
$string['centersid'] = 'Center ID';
$string['center'] = 'Center';
$string['addnewcenter'] = 'Add New Center';
$string['deletecenter'] = 'Delete Center';
$string['backtocenters'] = 'Back to Centers';
$string['createcenter'] = 'Create Center';
$string['centername'] = 'Center Name';
$string['idnumbercenter'] = 'Center ID Number';

if($CFG->theme == 'mghc2c'){
$string['centers'] = 'Institutes';
$string['centersid'] = 'Institute ID';
$string['center'] = 'Institute';
$string['addnewcenter'] = 'Add New Institute';
$string['deletecenter'] = 'Delete Institute';
$string['backtocenters'] = 'Back to Institute';
$string['createcenter'] = 'Create Institute';
$string['centername'] = 'Institute Name';
$string['idnumbercenter'] = 'Institute ID Number';
}

/* strings sent by yuokin */

/*login page*/

$string['Welcome_to_HzBooks_Education'] = 'Welcome to HzBooks Education';

/* home page */
$string['hello'] = 'Hello';
$string['You_are_studying'] = 'You are studying';
$string['completed'] = 'completed';
$string['noactivity']='No Activities';

$string['noclassfortheday']= 'No class scheduled on selected date';

$string['centeadminare']='center admin are';
$string['contactcenter']='Contact center admin for further queries.';

$string['centeadminare']='center admin are';
$string['contactcenter']='Contact center admin for further queries.';
$string['parentinfo']='If this user is a student then select the parent of this user from following list of users. If parent\'s name is not in the list you can create user(who will be assigned as parent to this user) and edit this user( student) and add parent later.';
$string['parent']='Parent';
$string['parentlist']='Parentlist';


$string['groupendtime'] ='End time should be later than the start time';
$string['groupclassdaysame']='Same day could not be allocated to conduct a class';
$string['groupclassday2']=' Second week day should be greater than first week day';

$string['lesson']='Lesson';
$string['todayclass']='Today\'s Classes';
$string['centeradminnocourse']='There are currently no courses in this Centre.';


$string['uploadusertemp']= 'Upload user template';

$string['student_check']='Student role check';
$string['student_check_text']=' Please check if this user will be enrolled as a student and you want to select parents for this student from the user list.';


/***** added by pankaj ******** 01/09/2012 * #251  Title is not correct of course creation page.******/
$string['createcoursesettings']= 'Create new course';
$string['createcourse']='Create course';
/***** added by pankaj ******** 01/09/2012 * #251  Title is not correct of course creation page.******/
$string['isstudying']='is studying';

$string['content_loading']='Loading course content...';
$string['class_activity_not_preseent']='Classes are not yet scheduled for this course';
$string['class_single_day_schedule']='This class was scheduled for single day';
$string['centeradminclassnotschedule'] =' is not scheduled for this course.';