...
$string['invalidbulkenrolop'] = 'Please select an option from the drop down list before clicking the "GO" button.';
...
$string['errorcourseactsel']='Please select an option from the dropdown of Activity or Resource';