<?php
    ...
    if (! $delete) {
        ...
        if(is_siteadmin() || is_mhescordinator()){
			...
			echo $OUTPUT->confirm($message, "delete.php?id=$course->id&delete=".md5($course->timemodified), $CFG->wwwroot."/centeradmin_courseview.php");
		}
    ...
    if(is_siteadmin() || is_mhescordinator()){
		...
		?><div><a href = "<?php echo $CFG->wwwroot; ?>/centeradmin_courseview.php"><b><u>Continue</u></b></a></div><?
	}
