...
require_once($CFG->dirroot.'/course/user_form.php');
...
$returnurl = $CFG->wwwroot.'/course/view.php?catid='.$_GET['catid'].'&id='.$_GET['id'];
...
if (empty($iid)) {
    $mform1 = new admin_uploaduser_form1($CFG->wwwroot.'/admin/tool/uploaduser/index.php');
...
if ($formdata = $mform2->is_cancelled()) {
    ...
    while ($line = $cir->next()) {
		...
		global $USER;
		if(!is_siteadmin() && !is_mhes_coordinator())
		{
