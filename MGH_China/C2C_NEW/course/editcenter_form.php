...
class editcenter_form extends moodleform {
    ...
    function definition() {
        ...
        if ($category->id) {
            ...
            $strsubmit = get_string('createcenter');
        }
        ...
        $mform->addElement('text', 'name', get_string('centername'), array('size'=>'30'));
        $mform->addRule('name', get_string('required'), 'required', null);
       // $mform->addElement('text', 'idnumber', get_string('idnumbercenter'),'maxlength="100"  size="10"');
