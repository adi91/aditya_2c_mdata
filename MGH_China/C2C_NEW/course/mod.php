...
if (!empty($add)) {
		...
		if(is_siteadmin()){
	        echo $OUTPUT->confirm(
	            ...
	            new single_button(
	                ...
	                'post'),
	            new single_button(
	                new moodle_url('/course/view.php?catid='.$course->category.'&id='.$course->id.'#section-' . $cm->sectionnum, array('id' => $cm->course)),
	                get_string('cancel'),
	                'get')
	        );
		}else{
			echo $OUTPUT->confirm(
	            ...
	            new single_button(
	                ...
	                'post'),
	            new single_button(
	                //new moodle_url('/course/courset.php#section-' . $cm->sectionnum, array('id' => $cm->course)),
					new moodle_url('/course/view.php?catid='.$course->category.'&id='.$course->id.'#section-' . $cm->sectionnum, array('id' => $cm->course)),
	                get_string('cancel'),
	                'get')
	        );
    ...
    if(is_siteadmin()){
		$return = "$CFG->wwwroot/course/view.php?catid=$course->category&id=$course->id#section-$cm->sectionnum";
	}else{
		//$return = "$CFG->wwwroot/course/courset.php?id=$cm->course#section-$cm->sectionnum";
		$return = "$CFG->wwwroot/course/view.php?catid=$course->category&id=$course->id#section-$cm->sectionnum";
	}
...
if ((!empty($movetosection) or !empty($moveto)) and confirm_sesskey()) {
    ...
    if (!ismoving($section->course)) {
		if(is_siteadmin()){
			print_error('needcopy', '', "view.php?catid=$course->category&id=$section->course");
		}else{
			//print_error('needcopy', '', "courset.php?id=$section->course");
			print_error('needcopy', '', "view.php?catid=$course->category&id=$section->course");
		}
    }
    ...
    if (SITEID == $section->course) {
		...
		if(is_siteadmin()){
			redirect("view.php?catid=$course->category&id=$course->id#section-$sectionreturn");
		}else{
			//redirect("courset.php?id=$section->course#section-$sectionreturn");
			redirect("view.php?catid=$course->category&id=$course->id#section-$sectionreturn");
		}
    }
    ...
    if (SITEID == $cm->course) {
		...
		if(is_siteadmin()){
			redirect("view.php?catid=$course->category&id=$cm->course#section-$cm->sectionnum");
		}else{
			//redirect("courset.php?id=$cm->course#section-$cm->sectionnum");
			redirect("view.php?catid='.$course->category.'&id='.$course->id.'#section-$cm->sectionnum");
		}
    }
    ...
    if (SITEID == $cm->course) {
	    ...
	    if(is_siteadmin()){
			...
			//redirect("courset.php?id=$cm->course#section-$cm->sectionnum");
			redirect("view.php?catid=$course->categoryid=$course->id#section-$cm->sectionnum");
		}
    }
    ...
    if(is_siteadmin()){
		redirect("view.php?catid=$course->category&id=$course->id");
	}else{
		//redirect("courset.php?id=$courseid");
		redirect("view.php?catid=$course->category&id=$course->id");
	}
