...
if (!$rc->execute_precheck()) {
    ...
    if (is_array($precheckresults) && !empty($precheckresults['errors'])) {
		...
		if(is_siteadmin()){
			...
			echo $output->continue_button(new moodle_url('/course/courset.php', array('id' => $course->id)));
		}
        echo $output->footer();
        die();
    }
...
if ($newcmid) {
    ...
    if(is_siteadmin()){
		...
		echo $output->continue_button(
	        new moodle_url('/course/courset.php#section-' . $cm->sectionnum, array('id' => $course->id))
	    );
	}
}
