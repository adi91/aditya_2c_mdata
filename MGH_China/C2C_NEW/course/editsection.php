...
if ($mform->is_cancelled()){
    ...
    if(is_siteadmin()){
		...
		redirect($CFG->wwwroot.'/course/courset.php?id='.$course->id);
	}*/
	redirect($CFG->wwwroot.'/course/view.php?catid='.$course->category.'&id='.$course->id.'#section-'.$section->section);
   ...
   //} else {
	...
	//$section->startdate = $data->startdate;
	...
	/*if(is_siteadmin()){
		...
		redirect("courset.php?id=$course->id");
	}*/
	redirect($CFG->wwwroot.'/course/view.php?catid='.$course->category.'&id='.$course->id.'#section-'.$section->section);
}
...
$strsummaryof = str_replace('Topic', get_string('lesson'), $strsummaryof);
