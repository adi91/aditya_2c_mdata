...
if ($mform->is_cancelled()) {
    if ($return && !empty($cm->id)) {
        redirect("$CFG->wwwroot/mod/$module->name/view.php?catid=$cm->category&id=$cm->id");
    } else {
			redirect("$CFG->wwwroot/course/view.php?catid=$course->category&id=$course->id#section-".$cw->section);
	}
    ...
    if (!empty($fromform->update)) {
        ...
        if (!$returnfromfunc or !is_number($returnfromfunc)) {
            ...
            if (!is_number($returnfromfunc)) {
                print_error('invalidfunction', '', "view.php?catid={$course->category}&id={$course->id}#section-{$cw->section}");
            } else {
                print_error('cannotaddnewmodule', '', "view.php?catid={$course->category}&id={$course->id}#section-{$cw->section}", $fromform->modulename);
            }
        }
    ...
    } else {	//redirect("$CFG->wwwroot/course/courset.php?id={$course->id}#section-{$cw->section}");
			redirect("$CFG->wwwroot/course/view.php?catid=$course->category&id=$course->id#section-{$cw->section}");
    }
    exit;
