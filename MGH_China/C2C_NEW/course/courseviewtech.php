...
//  Display the course home page.
    ...
    $PAGE->set_url('/course/courseviewtech.php', array('id' => $course->id)); // Defined here to avoid notices on errors etc
    ...
    add_to_log($course->id, 'course', 'view', "courseviewtech.php?id=$course->id", "$course->id");
    ...
    $SESSION->fromdiscussion = $CFG->wwwroot .'/course/courseviewtech.php?id='. $course->id;
    ...
    if ($PAGE->user_allowed_editing()) {
        $buttons = $OUTPUT->edit_button(new moodle_url('/course/courseviewtech.php', array('id' => $course->id)));
  ...
  //  $PAGE->set_heading($course->fullname);
	...
	$arr = array();
	$jsscript = "document.getElementById('container21').innerHTML='".addslashes($content)."';";
	$arr['jsscript']=$jsscript;
	json_encode($arr);*/
   // echo $OUTPUT->footer();
