...
?><div id="container" style="margin-left:200px;"><?php 
...
?><div id="container" style="margin-left:200px;"><?php 
echo $OUTPUT->header();
?><div style="border: 1px solid;clear: both;margin: 5px 0;padding: 5px;width: 99%;"><?php
echo $OUTPUT->box(get_string('passwordforgotteninstructions2'), '');
?></div><?php
 $mform->display(); ?></div><?php
