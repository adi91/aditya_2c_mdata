				    	...
				    	<div class="dashboard">
					        <div class="profile_block">
								...
								<?php if(is_student()){?>					            
									...
									$b = 0;
									if(is_teacher()){
										$mycourses = apt_enrol_get_users_courses($USER->id, true, NULL, 'visible DESC,sortorder ASC');
									}						
									...
									if(is_student()){
										$attendance_sql .= " and (studentid like '%@$USER->id@%' OR studentid like '%@$USER->id' OR studentid like '$USER->id@%' OR studentid like '$USER->id')";
									}elseif(is_teacher()){
								...
								<ul>
									...
									<?php if(is_institute_cordinator()){ ?>
										<?php
											...
											//echo '<pre>';print_r($institute_cordinator);echo '</pre>';
