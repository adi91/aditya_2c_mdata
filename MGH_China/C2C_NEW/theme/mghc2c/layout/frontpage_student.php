	...
	if(is_teacher() || is_non_editing_teacher())
		...
		switch($maindir)
		{
			case 'message': $class_message = "message_".$language."sel";
							break;
			case 'course': if(in_array($mainfile,$CFG->student_course))
			...
			case 'user':  if(in_array($mainfile,$CFG->student_profile))
						...
						break;
			default : if(in_array($mainfile,$CFG->student_lesson))
						$class_lesson= "lesson_".$language."sel";
					 else if(in_array($mainfile,$CFG->student_home))
					        ...
					        <div class="profile_block">
						       ...
						       <div class="verticle_navbar">
									<ul>
										...
										<?php }?>
										<?php if(is_teacher() || is_non_editing_teacher()){ ?>
