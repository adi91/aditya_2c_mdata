...
certificate_print_text($pdf, $x, $y, 'C', 'Times', '', 30, get_string('title', 'certificate'));
$pdf->SetTextColor(0, 0, 0);
certificate_print_text($pdf, $x, $y + 50, 'C', 'Times', '', 17, get_string('programme', 'certificate',$course->fullname));
certificate_print_text($pdf, $x, $y + 60, 'C', 'Times', '', 17,  certificate_get_date($certificate, $certrecord, $course));

certificate_print_text($pdf, $x, $y + 70, 'C', 'Times', '', 22, get_string('certify', 'certificate'));
certificate_print_text($pdf, $x, $y + 83, 'C', 'Times', '', 22, fullname($USER));
$pdf->Line($x+60, $y + 93, $x+210, $y +93,array('width' => 1.25));
certificate_print_text($pdf, $x, $y + 95, 'C', 'Times', '', 22, get_string('statement', 'certificate',$course->fullname));
