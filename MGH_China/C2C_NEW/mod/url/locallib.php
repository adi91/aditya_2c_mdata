...
<html dir="$dir">
  ...
  <frameset rows="$framesize,*">
    ...
    <iframe src="$exteurl" title="$modulename" style="width:100%; height:100%;" frameborder="0"></iframe>
  </frameset>
</html>
EOF;

        //@header('Content-Type: text/html; charset=utf-8');
        echo "<img src='".$CFG->wwwroot."/pix/spacer.gif'>";
        echo $extframe;
        die;
    }
}
...
function url_display_embed($url, $cm, $course) {
    ...
    } else if ($mimetype == 'video/x-flv' or $extension === 'f4v' or $mimetype === 'video/mp4') {
        // Flash video file
