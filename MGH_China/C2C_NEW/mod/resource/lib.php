...
function resource_get_coursemodule_info($coursemodule) {
    ...
    if ($display == RESOURCELIB_DISPLAY_POPUP) {
        ...
        $height = empty($options['popupheight']) ? 900 : $options['popupheight'];*/
        $width=1000;
        $height=900;
        $wh = "width=$width,height=$height,toolbar=no,location=no,menubar=no,copyhistory=no,status=no,directories=no,scrollbars=yes,resizable=yes,fullscreen=yes";
