    ...
    Y.extend(FilePickerHelper, Y.Base, {
        ...
        view_as_icons: function() {
            ...
            for(var k in list) {
				...
				/********** added by pankaj wagh ******** 01/09/2012 ** 254:Centre Admin - Filename display in Alfresco*****/ 
                title.innerHTML += '<a href="###" id="'+filename_id+'" title="'+node.title+'"><span style="word-wrap:break-word;">'+filename+"</span></a>";
				/********** added by pankaj wagh ******** 01/09/2012 ** 254:Centre Admin - Filename display in Alfresco*****/ 
