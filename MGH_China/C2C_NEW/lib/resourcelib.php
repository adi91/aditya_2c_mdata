...
function resourcelib_embed_flashvideo($fullurl, $title, $clicktoopen) {
    ...
    $output .= html_writer::script(js_writer::function_call('M.util.add_video_player', array($id, rawurlencode($fullurl), $width, $height, false)));
    $output .= '</div>';
...
EOT;
$code = '<OBJECT CLASSID="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" WIDTH="100%" HEIGHT="100%" CODEBASE="http://www.apple.com/qtactivex/qtplugin.cab">
		<PARAM name="AUTOPLAY" VALUE="true">
		<PARAM name="CONTROLLER" VALUE="false"> 
		<EMBED SRC="'.$fullurl.'" WIDTH="100%" HEIGHT="100%" AUTOPLAY="true" CONTROLLER="false" PLUGINSPAGE="http://www.apple.com/quicktime/download/">
		</EMBED>
		</OBJECT>';
...
function resourcelib_embed_pdf($fullurl, $title, $clicktoopen) {
    ...
    if(is_teacher() || is_non_editing_teacher() || is_centeradmin()){
    $code = <<<EOT
<div class="resourcecontent resourcepdf">
  <object id="resourceobject" data="$fullurl" type="application/pdf" width="100%" height="600">
    <param name="src" value="$fullurl" />
    $clicktoopen
  </object>
</div>
EOT;
    ...
    $code = <<<EOT
<div class="resourcecontent resourcepdf">
  <object id="resourceobject" data="$fullurl" type="application/pdf" width="600" height="500">
    <param name="src" value="$fullurl" />
    $clicktoopen
  </object>
</div>
EOT;
   ...
   //$PAGE->requires->js_init_call('M.util.init_maximised_embed', array('resourceobject'), false);
