...
echo html_writer::link(new moodle_url('/user/edit.php?id='.$user->id), get_string('editmyprofile'), array('class'=>'buttonstyled'));
echo html_writer::end_tag('a');
echo '</div>';
echo '<div style="margin-top:5px;">';
echo html_writer::start_tag('a');
echo html_writer::link(new moodle_url('/login/change_password.php?id=1'), get_string('changepassword'), array('class'=>'buttonstyled'));
echo html_writer::end_tag('a');
echo '</div>';
