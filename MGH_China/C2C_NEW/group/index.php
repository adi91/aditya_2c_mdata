...
echo '<div style="padding:10px 0;float:left;width:98%;background:#ccc;clear:both;">';
...
echo '<div style="padding:10px 0;float:left;width:98%;clear:both;">'."\n";
...
if ($groups) {
    // Print out the HTML
	//echo '<option>Click on a class below to view members</option>';
...
echo '</select>'."\n";
//echo '<img src="http://localhost/mgh_china/pix/logo.jpg" onload="'.$onchange.'" width="100" height="132">';
