...
echo '<div style="padding:10px 0;float:left;width:98%;background:#ccc;">';
echo $OUTPUT->heading('Batches');
echo '</div>';
$data = array();
...
$table->head  = array('Batch', $strgroups, $struses, $stredit);
...
echo $OUTPUT->single_button(new moodle_url('grouping.php', array('courseid'=>$courseid)), 'Create Batch');
