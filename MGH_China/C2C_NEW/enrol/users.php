...
if ($action) {
    ...
    switch ($action) {
         ...
         * * Swapnil: Added site_fk in get user record 2/04/12
         */
        case 'assign':
            $user = $DB->get_record('user', array('id'=>required_param('user', PARAM_INT), 'site_fk'=>$USER->site_fk,'deleted'=>0), '*', MUST_EXIST);
